...
%
% BUG?!: z=[] overwrites calculated z. Has not wanted to modify the code without knowing it. /Erik P G Johansson 2015-05-19
%
% z = zero_cross(Vb,I)
function z = zero_cross(Vb,I)
    ...
    z = [];                % BUG?!! return z=[] also when z previously set.
end
