...
if(~isempty(an_tabindex));
    ...
    for(i=1:len)
        ...
        if strcmp(an_tabindex{i,7}, 'best_estimates')
            ...
            try
                kv = createLBL_create_EST_LBL_header(an_tabindex(i, :), index);
            catch exc
        ...
        createLBL_write_LBL_header(fid, kv)
...
%             
        ...
        elseif  strcmp(an_tabindex{i,7},'best_estimates') %%%%%%%%%%%% BEST ESTIMATES FILE %%%%%%%%%%%%
            ...
            cl{end+1} = struct('NAME', 'Vsc',                'DATA_TYPE', 'ASCII_REAL', 'BYTES', 14, 'UNIT', 'V',       'DESCRIPTION', 'Best estimate of spacecraft potential.');
