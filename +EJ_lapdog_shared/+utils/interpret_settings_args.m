...
% Assign settings
%=================
settings = EJ_lapdog_shared.utils.add_struct_to_struct(settingsArg1, defaultSettings, ...
    struct('noStructs', 'Do nothing', 'aIsStruct', 'Do nothing', 'bIsStruct', 'Do nothing', 'bothAreStructs', 'Do nothing'));
settings = EJ_lapdog_shared.utils.add_struct_to_struct(settings, settingsArgListPairs, ...
    struct('noStructs', 'Do nothing', 'aIsStruct', 'Do nothing', 'bIsStruct', 'Do nothing', 'bothAreStructs', 'Do nothing'));
